...
#sound files (button_click.wav, tie_game.wav, and game_win.wav) in the same directory as your Python script for this to work
...
def play_round(user_choice):
    ...
    if winner == "Tie":
        ...
        play_sound_effect('tie_game.wav')
    else:
        result_var.set(f"{winner} wins!")
        play_sound_effect('game_win.wav')
...
user_label = tk.Label(frame, text="Rock Paper Scissors", font='10').grid(row=1, column=0, padx=10, pady=10)
